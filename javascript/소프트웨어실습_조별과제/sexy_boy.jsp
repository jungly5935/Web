...
function sexy_change(){

sexy = ['남자연예인/서강준.jpg','남자연예인/뷔.jpg','남자연예인/데인드한.jpg','남자연예인/섹시_강동원.jpg','남자연예인/섹시_김재욱.jpg'];
sexy_ran = Math.floor(Math.random()*sexy.length);
$('#q img').attr('src', sexy[sexy_ran]);
var ab = document.getElementById("q");
ab.src = sexy[sexy_ran];
