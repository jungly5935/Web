...
cute = ['남자연예인/정국.jpg','남자연예인/시우민.jpg','남자연예인/이수근.jpg', '남자연예인/큐티_이창섭.jpg', '남자연예인/큐티_최우식.jpg'];
cute_ran = Math.floor(Math.random()*cute.length);
$('#dog img').attr('src', cute[cute_ran]);
var ab = document.getElementById("dog");
...
//자바스크립트 값을 html의 hidden값으로 form submit 하는방법?

//var URL = "cute.jsp?cute_ran=" +cute_ran
...
<div id="cute" align="center">
	<img id = "dog" src="아이콘/물음표.jpg" alt=""><br>
